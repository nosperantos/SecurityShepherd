...
public class TestProperties {
  public static void executeSql(org.apache.log4j.Logger log) throws InstallationException {
    try {
      ...
      file =
          new File(
              System.getProperty("user.dir") + "/src/main/resources/database/moduleSchemas.sql");
  ...
  public static void createFileSystemKey(
      org.apache.log4j.Logger log, String fileProp, String solutionProp)
  ...
  public static void loginDoPost(
    ...
    try {
      ...
      if (response.getStatus() != expectedResponseCode)
        throw new Exception(
            "Login Servlet Returned " + response.getStatus() + " Code. 302 Expected");
  ...
  public static boolean verifyTestUser(
      org.apache.log4j.Logger log, String applicationRoot, String userName, String password)
      throws Exception {
   ...
   */
  public static String findCreateClassId(
      org.apache.log4j.Logger log, String className, String applicationRoot) throws Exception {
