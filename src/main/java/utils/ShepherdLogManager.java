...
public class ShepherdLogManager {
  ...
  public static void logEvent(
      Object theIp, String theForwardedIp, String theMessage, Object theUser) {
    String userName = new String();
    if (theUser != null) userName = theUser.toString();
    if (userName.isEmpty()) userName = new String("UnknownUser");
