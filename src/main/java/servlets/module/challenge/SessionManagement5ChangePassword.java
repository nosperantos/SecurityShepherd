...
public class SessionManagement5ChangePassword extends HttpServlet {
  ...
  private static org.apache.log4j.Logger log =
      Logger.getLogger(SessionManagement5ChangePassword.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        if (passNewObj != null) newPass = (String) passNewObj;
        if (userNewObj != null) userName = (String) userNewObj;
        if (tokenObj != null) token = (String) tokenObj;
